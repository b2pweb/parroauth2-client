...
class TokenEndPointAuthenticationTest extends UnitTestCase
{
    ...
    public function test_with_jwt_bearer_unit()
    {
        ...
        $this->httpClient->addResponse(new Response(200, [], json_encode(['access_token' => 'my-access-token'])));
        $this->endPoint->code('my-authorization-code')->call();
        ...
        $this->assertSame('my-authorization-code', $body['code']);
